...
class Publication(InformationContentEntity):
    ...
    year: Optional[int] = Field(
        None, description="""Year in which the paper was published."""
    )
...
class Submission(BaseModel):
    ...
    has_individual: Union[List[AnnotatedIndividual], List[str]] = Field(
        None,
        description="""Information about one or more Individual entities associated with this submission.""",
    )
    has_experiment: Union[List[Experiment], List[str]] = Field(
        None,
...
class Biospecimen(MaterialEntity):
    ...
    has_individual: Union[AnnotatedIndividual, str] = Field(
        None,
...
class Analysis(DataTransformation):
    ...
    has_workflow: Optional[Union[List[Workflow], List[str]]] = Field(
        None,
...
class Sample(MaterialEntity):
    ...
    has_anatomical_entity: Union[List[AnatomicalEntity], List[str]] = Field(
...
class DataAccessPolicy(InformationContentEntity):
    ...
    has_data_use_modifier: Optional[Union[List[DataUseModifier], List[str]]] = Field(
        None,
...
class DataAccessCommittee(Committee):
    ...
    main_contact: Union[Member, str] = Field(
